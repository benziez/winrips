...
export const FOOTER_CONTENT: Record<FooterPageSlug, FooterPageContent> = {
  ...
  "responsible-play": {
    ...
    paragraphs: [
      ...
      "Pack Imagery Disclaimer — Card pack designs shown in the app are for illustrative purposes only and do not represent physical packaging. All physical cards are shipped in standard protective sleeves and cardboard packaging to ensure safe delivery.",
    ],
  },
};
